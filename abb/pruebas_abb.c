...
static void prueba_abb_volumen(size_t largo, bool debug)
{
    ...
    unsigned i = 0;
    while (i < largo) {
        sprintf(claves[i], "%08ld", rand() % largo);
...
bool contador(const char* clave, void* dato, void* suma) {
    *(int*) suma += 1;
    return true;
}

static void prueba_abb_iterador_interno_sin_condicion()
{
    abb_t* abb = abb_crear(strcmp,NULL);

    char *clave1 = "A", *valor1 = "a";
    char *clave2 = "B", *valor2 = "b";
    char *clave3 = "C", *valor3 = "c";
    ...
    size_t suma = 0;
    abb_in_order(abb, contador, &suma);
    print_test("Se itero hasta el final con el iter interno", suma == 3);
    abb_destruir(abb);
}

bool iterar_hasta_encontrar(const char* clave, void* dato, void* suma) {
    if (strcmp("c", dato) == 0) {
		*(int*) suma += 1;
		return false;
	}
...
static void prueba_abb_iterador_interno_con_condicion()
{
    abb_t* abb = abb_crear(strcmp,NULL);

    char *clave1 = "B", *valor1 = "p";
    char *clave2 = "F", *valor2 = "u";
    char *clave3 = "K", *valor3 = "c";
    char *clave4 = "G", *valor4 = "c";
    char *clave5 = "A", *valor5 = "r";
    char *clave6 = "R", *valor6 = "p";
    ...
    /* Itera hasta el final. */
    size_t suma = 0;
    abb_in_order(abb, iterar_hasta_encontrar, &suma);
    print_test("Se itero sin visitarlos a todos", suma != abb_cantidad(abb));
    abb_destruir(abb);
}
...
void pruebas_abb_estudiante()
{
    ...
    prueba_abb_iterador_interno_sin_condicion();
    prueba_abb_iterador_interno_con_condicion();
